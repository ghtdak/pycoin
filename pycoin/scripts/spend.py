...
def main():
    ...
    parser.add_argument('-d',
                        ...
                        required=True,
                        metavar='dest_address/amount_in_btc',
                        nargs="+")
    parser.add_argument('-f',
                        "--wif-file",
                        help='WIF items for source Bitcoin addresses',
                        required=True,
                        metavar="path-to-WIF-values",
    ...
    if actual_tx_fee > recommended_tx_fee:
        print("warning: transaction fee of exceeds expected value of %s" %
              recommended_tx_fee)
    elif actual_tx_fee < recommended_tx_fee:
        print(
            "warning: transaction fee lower than (casually calculated) expected value of %s, transaction might not propogate"
            % recommended_tx_fee)
    print(
