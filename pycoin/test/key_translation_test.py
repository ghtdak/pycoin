...
class BuildTxTest(unittest.TestCase):
    ...
    def test_translation(self):
        ...
        def do_test(exp_hex, wif, c_wif, public_pair_sec, c_public_pair_sec,
            ...
            self.assertEqual(
                bitcoin_address_to_ripemd160_sha256_sec(c_address_b58),
                public_pair_to_ripemd160_sha256_sec(pk_public_pair,
                                                    compressed=True))
            ...
            self.assertEqual(
                bitcoin_address_to_ripemd160_sha256_sec(address_b58),
                public_pair_to_ripemd160_sha256_sec(pk_public_pair,
                                                    compressed=False))
