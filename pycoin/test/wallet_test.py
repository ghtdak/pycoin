...
class Bip0032TestCase(unittest.TestCase):
    ...
    def test_vector_1(self):
        ...
        self.assertEqual(
            m0p.wallet_key(is_private=True),
            "xprv9uHRZZhk6KAJC1avXpDAp4MDc3sQKNxDiPvvkX8Br5ngLNv1TxvUxt4cV1rGL5hj6KCesnDYUhd7oWgT11eZG7XnxHrnYeSvkzY7d2bhkJ7")

        pub_mp0 = master.subkey(is_prime=True, is_private=False)
        self.assertEqual(pub_mp0.wallet_key(
        ), "xpub68Gmy5EdvgibQVfPdqkBBCHxA5htiqg55crXYuXoQRKfDBFA1WEjWgP6LHhwBZeNK1VTsfTFUHCdrfp1bgwQ9xv5ski8PX9rL2dZXvgGDnw")

        m0p1 = m0p.subkey(i=1)
        self.assertEqual(m0p1.wallet_key(
        ), "xpub6ASuArnXKPbfEwhqN6e3mwBcDTgzisQN1wXN9BJcM47sSikHjJf3UFHKkNAWbWMiGj7Wf5uMash7SyYq527Hqck2AxYysAA7xmALppuCkwQ")
        self.assertEqual(
            m0p1.wallet_key(is_private=True),
            "xprv9wTYmMFdV23N2TdNG573QoEsfRrWKQgWeibmLntzniatZvR9BmLnvSxqu53Kw1UmYPxLgboyZQaXwTCg8MSY3H2EU4pWcQDnRnrVA1xe8fs")

        pub_m0p1 = m0p.subkey(i=1, is_private=False)
        self.assertEqual(pub_m0p1.wallet_key(
        ), "xpub6ASuArnXKPbfEwhqN6e3mwBcDTgzisQN1wXN9BJcM47sSikHjJf3UFHKkNAWbWMiGj7Wf5uMash7SyYq527Hqck2AxYysAA7xmALppuCkwQ")
        ...
        self.assertEqual(
            m0p1_1_2p.wallet_key(is_private=True),
            "xprv9z4pot5VBttmtdRTWfWQmoH1taj2axGVzFqSb8C9xaxKymcFzXBDptWmT7FwuEzG3ryjH4ktypQSAewRiNMjANTtpgP4mLTj34bhnZX7UiM")

        pub_m0p1_1_2p = m0p1.subkey(i=2, is_private=False, is_prime=True)
        self.assertEqual(pub_m0p1_1_2p.wallet_key(
        ), "xpub6D4BDPcP2GT577Vvch3R8wDkScZWzQzMMUm3PWbmWvVJrZwQY4VUNgqFJPMM3No2dFDFGTsxxpG5uJh7n7epu4trkrX7x7DogT5Uv6fcLW5")

        m0p1_1_2p_2 = m0p1_1_2p.subkey(i=2)
        self.assertEqual(m0p1_1_2p_2.wallet_key(
        ), "xpub6FHa3pjLCk84BayeJxFW2SP4XRrFd1JYnxeLeU8EqN3vDfZmbqBqaGJAyiLjTAwm6ZLRQUMv1ZACTj37sR62cfN7fe5JnJ7dh8zL4fiyLHV")
        self.assertEqual(
            m0p1_1_2p_2.wallet_key(is_private=True),
        ...
        self.assertEqual(m0p1_1_2p_2_1000000000.wallet_key(
        ), "xpub6H1LXWLaKsWFhvm6RVpEL9P4KfRZSW7abD2ttkWP3SSQvnyA8FSVqNTEcYFgJS2UaFcxupHiYkro49S8yGasTvXEYBVPamhGW6cFJodrTHy")
        self.assertEqual(
            m0p1_1_2p_2_1000000000.wallet_key(is_private=True),
    ...
    def test_vector_2(self):
        ...
        m0 = master.subkey()
        self.assertEqual(m0.wallet_key(
        ), "xpub69H7F5d8KSRgmmdJg2KhpAK8SR3DjMwAdkxj3ZuxV27CprR9LgpeyGmXUbC6wb7ERfvrnKZjXoUmmDznezpbZb7ap6r1D3tgFxHmwMkQTPH")
        self.assertEqual(
            m0.wallet_key(is_private=True),
            "xprv9vHkqa6EV4sPZHYqZznhT2NPtPCjKuDKGY38FBWLvgaDx45zo9WQRUT3dKYnjwih2yJD9mkrocEZXo1ex8G81dwSM1fwqWpWkeS3v86pgKt")
        pub_m0 = master.subkey(is_private=False)
        self.assertEqual(pub_m0.wallet_key(
        ), "xpub69H7F5d8KSRgmmdJg2KhpAK8SR3DjMwAdkxj3ZuxV27CprR9LgpeyGmXUbC6wb7ERfvrnKZjXoUmmDznezpbZb7ap6r1D3tgFxHmwMkQTPH")
        ...
        self.assertEqual(
            m0_2147483647p.wallet_key(is_private=True),
        ...
        self.assertEqual(m0_2147483647p_1.wallet_key(
        ), "xpub6DF8uhdarytz3FWdA8TvFSvvAh8dP3283MY7p2V4SeE2wyWmG5mg5EwVvmdMVCQcoNJxGoWaU9DCWh89LojfZ537wTfunKau47EL2dhHKon")
        self.assertEqual(
            m0_2147483647p_1.wallet_key(is_private=True),
        ...
        self.assertEqual(
            m0_2147483647p_1_2147483646p.wallet_key(is_private=True),
            "xprvA1RpRA33e1JQ7ifknakTFpgNXPmW2YvmhqLQYMmrj4xJXXWYpDPS3xz7iAxn8L39njGVyuoseXzU6rcxFLJ8HFsTjSyQbLYnMpCqE2VbFWc")
        pub_m0_2147483647p_1_2147483646p = m0_2147483647p_1.subkey(
            i=2147483646, is_private=False,
            is_prime=True)
        ...
        m0_2147483647p_1_2147483646p_2 = m0_2147483647p_1_2147483646p.subkey(
            i=2)
        self.assertEqual(m0_2147483647p_1_2147483646p_2.wif(),
                         "L3WAYNAZPxx1fr7KCz7GN9nD5qMBnNiqEJNJMU1z9MMaannAt4aK")
        self.assertEqual(m0_2147483647p_1_2147483646p_2.wallet_key(
        ), "xpub6FnCn6nSzZAw5Tw7cgR9bi15UV96gLZhjDstkXXxvCLsUXBGXPdSnLFbdpq8p9HmGsApME5hQTZ3emM2rnY5agb9rXpVGyy3bdW6EEgAtqt")
        self.assertEqual(
            m0_2147483647p_1_2147483646p_2.wallet_key(is_private=True),
            "xprvA2nrNbFZABcdryreWet9Ea4LvTJcGsqrMzxHx98MMrotbir7yrKCEXw7nadnHM8Dq38EGfSh6dqA9QWTyefMLEcBYJUuekgW4BYPJcr9E7j")
        pub_m0_2147483647p_1_2147483646p_2 = m0_2147483647p_1_2147483646p.subkey(
            i=2, is_private=False)
    ...
    def test_streams(self):
        ...
        for i in range(10):
            ...
            m3 = m2.public_copy()
            self.assertEqual(
                m.wallet_key(is_private=True),
                m2.wallet_key(is_private=True))
            ...
            for j in range(10):
                ...
                k4 = k.public_copy()
                self.assertEqual(
                    k.wallet_key(is_private=True),
                    k2.wallet_key(is_private=True))
