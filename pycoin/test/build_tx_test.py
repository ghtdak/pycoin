...
class BuildTxTest(unittest.TestCase):
    ...
    def test_build_spends(self):
        ...
        unsigned_coinbase_spend_tx = UnsignedTx.standard_tx(coins_from,
                                                            coins_to)
        ...
        unsigned_spend_tx = UnsignedTx.standard_tx(
            [(coinbase_spend_tx.hash(), 0, coinbase_spend_tx.txs_out[0])],
