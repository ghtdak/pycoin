...
class ScriptTypesTest(unittest.TestCase):
    ...
    def test_validate_multisig(self):
        ...
        f = io.BytesIO(h2b(
            ""))
        tx = Tx.parse(f)
        tx.parse_unspents(f)
        self.assertEqual(
            tx.id(),
    ...
    def test_p2sh_multisig_sequential_signing(self):
        raw_scripts = [
            '52210234abcffd2e80ad01c2ec0276ad02682808169c6fafdd25ebfb60703df272b4612102e5baaafff8094e4d77ce8b009d5ebc3de9110085ebd3d96e50cc7ce70faf1752210316ee25e80eb6e6fc734d9c86fa580cbb9c4bfd94a19f0373a22353ececd4db6853ae'.decode(
                'hex')
        ]
        txs_in = [TxIn(
            previous_hash='43c95d14724437bccc102ccf86aba1ac02415524fd1aefa787db886bba52a10c'.decode(
                'hex'),
            previous_index=0)]
        txs_out = [TxOut(10000, standard_tx_out_script(
