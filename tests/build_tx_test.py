...
def standard_tx(coins_from, coins_to):
    ...
    for coin_value, bitcoin_address in coins_to:
        txs_out.append(TxOut(coin_value, standard_tx_out_script(
            bitcoin_address)))
...
class BuildTxTest(unittest.TestCase):
    ...
    def test_standard_tx_out(self):
        ...
        s = str(tx_out)
        self.assertEqual(
            'TxOut<0.0001 mbtc "OP_DUP OP_HASH160 [745e5b81fd30ca1e90311b012badabaa4411ae1a] OP_EQUALVERIFY OP_CHECKSIG">',
            s)
