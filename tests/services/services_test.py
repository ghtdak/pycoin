...
class ServicesTest(unittest.TestCase):
    ...
    def test_thread_provider(self):
        p_list_1 = providers.providers_for_config_string("blockchain.info",
                                                         "BTC")
        p_list_2 = providers.providers_for_config_string("blockexplorer.com",
                                                         "BTC")
    ...
    def test_BlockExplorerProvider(self):
        self.check_provider_tx_for_tx_hash(BlockExplorerProvider,
                                           ["BTC", "XTN"])
    ...
    def test_ChainSoProvider(self):
        self.check_provider_tx_for_tx_hash(ChainSoProvider,
                                           ["BTC", "XTN", "DOGE", "XDT"])
