...
from pycoin.ecdsa import sign, verify, public_pair_for_secret_exponent, \
    possible_public_pairs_for_signature, generator_secp256k1
...
class SigningTest(unittest.TestCase):
    def test_sign(self):
        for se in [
            ...
            public_pairs = possible_public_pairs_for_signature(
                generator_secp256k1, val, sig)
